...
export {TICK_VALUE, TICK_DAY, BASE_EXPERIENCE, EXPERIENCE_SCALING, STAMINA_SCALING, HUNGER_SCALING, HAPPINESS_MODIFIER, LEVEL1_EXPERIENCE, LEVEL1_HUNGER, LEVEL1_STAMINA, LEVEL1_HAPPINESS, HAPPINESS_NAMES}
