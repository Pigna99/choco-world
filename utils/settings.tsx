const CREATURE_ID  = "65193d0fd0780be48381e964"
const TICK_VALUE = 5;
const TICK_DAY = TICK_VALUE*12*24;
...
export {CREATURE_ID, TICK_VALUE, TICK_DAY, BASE_EXPERIENCE, EXPERIENCE_SCALING, STAMINA_SCALING, HUNGER_SCALING, HAPPINESS_MODIFIER, LEVEL1_EXPERIENCE, LEVEL1_HUNGER, LEVEL1_STAMINA, LEVEL1_HAPPINESS}
